...
3. [Commonly Used Commands](#3-commonly-used-commands)
...
* **Run Unit Tests:**
  ...
  <img width="1678" height="370" alt="mvn test" src="https://github.com/user-attachments/assets/afb6314b-b712-4013-9d54-d40d08dd6d6b" />
...
* **Install to Local Repository (~/.m2/repository):**
 ...
 <img width="1831" height="633" alt="mvn install" src="https://github.com/user-attachments/assets/42cca481-fb13-4e45-81f3-55653d8c9820" />
...
* **Show Full Error Stack Trace:**
  ...
  <img width="1685" height="568" alt="cleaninstall -e" src="https://github.com/user-attachments/assets/e508c234-e0e5-4eb0-b8b1-b1ca000ec596" />
...
* **Force Update Dependencies and Plugins (Bypasses local cache):**
  ...
  <img width="1774" height="575" alt="cleaninstall -U" src="https://github.com/user-attachments/assets/d33fa725-7929-463a-9730-39c95da7a592" />
...
* **Check System Environment and Java Info:**
  ...
  <img width="1853" height="909" alt="help:system" src="https://github.com/user-attachments/assets/c2b0c7fd-b064-45fe-a161-c114d335fe62" />
...
* **Clear Local Repository Cache (Force re-downloads):**
 ...
 <img width="1285" height="131" alt="rm ~/.m2/repository" src="https://github.com/user-attachments/assets/82c3bc88-3d60-4f28-a412-6d2c87966e7a" />
